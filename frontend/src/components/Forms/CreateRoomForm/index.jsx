    ...
    return (
        <form className="form col-md-12 mt-5 ">
            <div className="form-group">
                <input type="text" className="form-control my-1" placeholder="Enter Your Name" value={name} onChange={(e) => setName(e.target.value)} />
            </div>
            ...
            <button type="submit" onClick={handleCreateRoom} className="mt-4 btn btn-primary w-100">Generate Room</button>
        </form>    
    )
};
